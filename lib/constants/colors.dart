...
const Color backGColor = Color(0xffF4F2EE);
const Color buttounColor = Color(0xff1C1A3A);

const Color secondeButtounColor2 = Color(0xffD9D9D9);

const Color wPurble = Color.fromARGB(255, 74, 72, 124);
